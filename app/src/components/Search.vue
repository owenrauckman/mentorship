<template>
  <div class="search">
    ...
    <div id="js__m__search__filters" class="m__search__filters">
      ...
      <div class="m__search__filters__form">
        <div class="m__search__filters__form__radio">
          <div class="m__search__filters__form__radio__item m__search__filters__form__radio__item--active">Mentor</div>
          <div class="m__search__filters__form__radio__item">Mentee</div>
        </div>
        <input v-model="searchData.skill" class="m__search__filters__form__input" placeholder="Skill..."/>
        <input v-model="searchData.location" class="m__search__filters__form__input" placeholder="Location..."/>
    ...
    <section class="m__search">
      ...
      <div class="m__search__results">
        <div class="m__search__results__profile">
...
export default {
  ...
  methods: {
    performSearch(e){
      e.preventDefault(); //keep form from submitting ${this.user.username}
      var that = this;
      $.ajax({method: "GET", url: `http://localhost:3000/api/users/skillsPossessed/${that.searchData.skill}`, context: this, crossDomain: true})
        .done(function(response) {
          console.log(`http://localhost:3000/api/users/skillsPossessed/${that.searchData.skill}`);
          if(response){
